...
import { ITest, TestService, TestDetailsComponent, TestListComponent, TestNewComponent } from '../';
...
describe('TestListComponent', () => {
  ...
  let data: ITest[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TestListComponent, ListComponent],
        imports: [TestingModule],
        providers: [TestService, ChangeDetectorRef],
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/test/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
