...
import { ITest, TestService, TestNewComponent } from '../';
  ...
  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [TestNewComponent, NewComponent, FieldsComp],
        imports: [TestingModule],
        providers: [TestService, { provide: MAT_DIALOG_DATA, useValue: {} }],
  ...
  describe('Integration tests', () => {
    ...
    describe('', () => {
      it('should set the passed data to form', async () => {
        TestBed.configureTestingModule({
          declarations: [TestNewComponent, NewComponent, FieldsComp].concat(EntryComponents),
          imports: [TestingModule],
          providers: [TestService, { provide: MAT_DIALOG_DATA, useValue: relationData }],
        });
